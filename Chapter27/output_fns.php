...
<form class="" action="memberphp" method="post">
  <table bgcolor="#cccccc">
    ...
    <tr><td colspan="2"><a href="forgot_form.php">Forgot your password?</a></td></tr>
  </table>
</form>
<?php
}
...
?>
<form class="" action="register_new.php"  method="post">
  <table bgcolor="#cccccc">
    <tr>
      <td>Email address:</td>
...
<?php
  ...
  if((is_array($url_array)) && (count($url_array)>0)){
      foreach($url_array as $url){
        ...
        echo "<tr bgcolor=\"".$color."\"><td><a href=\"".$url."\">".htmlspecialchars($url).
        "</a></td></tr>";
      }
